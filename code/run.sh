...
python runClassification.py gbdt qgoldYNAllFeature_train.txt baseQAllFeature_dev.txt orderYNDevGBDT.txt

python runClassification.py essemble qgoldYNAllFeature_train.txt baseQAllFeature_dev.txt orderYNDevESSEMBLE.txt

python runClassification.py tree qgoldYNAllFeature_train.txt baseQAllFeature_dev.txt orderYNDevTREE.txt

python runClassification.py knn qgoldYNAllFeature_train.txt baseQAllFeature_dev.txt orderYNDevKNN.txt

python runClassification.py svm qgoldYNAllFeature_train.txt baseQAllFeature_dev.txt orderYNDevSVM.txt

python dealResultYN.py prefixDevYN.txt orderYNDevGBDT.txt devGBDTYN.txt

python dealResultYN.py prefixDevYN.txt orderYNDevESSEMBLE.txt devESSEMBLEYN.txt

python dealResultYN.py prefixDevYN.txt orderYNDevTREE.txt devTREEYN.txt

python dealResultYN.py prefixDevYN.txt orderYNDevKNN.txt devKNNYN.txt

python dealResultYN.py prefixDevYN.txt orderYNDevSVM.txt devSVMYN.txt
